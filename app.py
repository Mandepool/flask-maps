    ...
    margin-bottom: 15px;
        ...
        <body>
            ...
            <h1 class="header-with-logos">
                <img src="{{ url_for('static', filename='photo_2025-10-23_18-18-24.jpg') }}" alt="Левый логотип" class="logo">
                Маршруты СКФУ
                <img src="{{ url_for('static', filename='photo_2025-10-24_17-04-27.jpg') }}" alt="Правый логотип" class="logo">
            </h1>
            <div class="container">
